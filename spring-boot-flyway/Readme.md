...
# springboot 3.0 目前似乎不支持 5.7的mysql 和 flyway 同时使用

# 需要在数据库的配置文件中加入: &createDatabaseIfNotExist=true 这样就可以自动建表
...
<img src="http://static.example.com/spring-boot-demo/flyway/062903.jpg" alt="image-20200305105632047" style="zoom:50%;" />

查看下 `flyway-schema-history` 表

<img src="http://static.example.com/spring-boot-demo/flyway/062901.jpg" alt="image-20200305110147176" style="zoom:50%;" />
...
<img src="http://static.example.com/spring-boot-demo/flyway/062851.jpg" alt="image-20200305105958181" style="zoom:50%;" />

查看下 `flyway-schema-history` 表

<img src="http://static.example.com/spring-boot-demo/flyway/062908.jpg" alt="image-20200305110057768" style="zoom:50%;" />
